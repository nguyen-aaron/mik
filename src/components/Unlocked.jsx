  ...
  return (
    <div className="unlocked-container">
      <div className="message">
        <h1>Hi Mikayla!</h1>
        <p>It is really you. I hope you are doing amazing! I made this website for you. I just wanted to share some photos with you. Maybe I will be able add some more in the future. Can we talk? I have so much to tell you. Facetime tonight (9/15/2024)?</p>
      </div>
